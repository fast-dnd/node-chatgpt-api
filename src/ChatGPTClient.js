...
export default class ChatGPTClient {
    constructor(
        ...
        this.modelOptions = {
            ...
            presence_penalty: typeof modelOptions.presence_penalty === 'undefined' ? 1.1 : modelOptions.presence_penalty,
    ...
    async buildPrompt(messages, parentMessageId, isChatGptModel = false) {
        ...
        if (isChatGptModel) {
            ...
            console.log(`current token count for parentId ${parentMessageId}:, ${currentTokenCount}`);
        } else {
